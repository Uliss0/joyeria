...
const DEVELOPER_FEE_RATE = 0.04;
const EXCLUDED_ORDER_STATUSES = ["CANCELLED", "REFUNDED"] as const;

type PresetRange = "7d" | "30d" | "90d" | "month" | "year" | "all" | "custom";
...
function getDateRange(preset: PresetRange, from: string | null, to: string | null) {
  const now = new Date();
