...
<div className="mt-6">
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2  text-gray-600">Selecciona aqui para continuar con :</span>
          </div>
        </div>
        ...
        <div className="mt-6 grid  gap-3 ">
          <Button
            ...
            disabled={isLoading}
            className="w-full h-10 bg-white cursor-pointer hover:bg-gray-100 border-gray-300 text-gray-700 flex items-center justify-center"
          >
         ...
         <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2  text-gray-600">O con tu email:</span>
          </div>
        </div>
